...
<html>
	...
	<title>Sistem Informasi Sekolah Dasar</title>
...
.navbar-custom .collapse .navbar-nav > li > a:hover,
.navbar-custom .collapse .navbar-nav > li > a:focus {
    background: none;
    color: #fff;
}

.navbar-custom .collapse .navbar-nav .dropdown-menu {
    margin-top: 10px;
}
...
<div class="container">
	<div id="main" class="row">
							...
							<div class="panel-body">
								<table class="table table-responsive" border="1">
									<tr>
										...
										<th class="text-center text-capitalize">No.Induk Siswa</th>
									...
									@foreach($data as $row)
										<tr>
											<td class="text-center text-capitalize">{{$i}}</td>
											<td class="text-left text-capitalize">{{$row->nama_siswa}}</td>
											<td class="text-left text-capitalize">{{$row->no_induk_siswa}}</td>
											<td class="text-center text-capitalize">{{$row->nama_kelas}}</td>
											<td class="text-center text-capitalize">{{$row->jenis_kelamin}}</td>
											<td class="text-center text-capitalize">{{$row->alamat}}</td>
										</tr>
										@php
											$i++;
										@endphp
		...
		<footer class="footer">
		    <div class="container">
		        <p class="text-muted">Copyright &copy; <?php echo date('Y'); ?> | Created By : Programmer Ripuh Team | All Right Reserved</p>
		    </div>
		</footer>
	</div>
